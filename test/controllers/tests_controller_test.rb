...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { service_name: @test.service_name, service_url: @test.service_url } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { service_name: @test.service_name, service_url: @test.service_url } }
